...
var ColorPickerDirective = (function () {
    function ColorPickerDirective(resolver, vcRef, el, service) {
    ...
    ColorPickerDirective.prototype.onClick = function () {
        if (!this.created) {
            this.created = true;
            var dialogComponentFactory = this.resolver.resolveComponentFactory(DialogComponent);
            var dialogComponentRef = this.vcRef.createComponent(dialogComponentFactory, 0);
            dialogComponentRef.instance.setDialog(this, this.el, this.colorPicker, this.cpPosition, this.cpPositionOffset, this.cpPositionRelativeToArrow, this.cpOutputFormat, this.cpCancelButton, this.cpCancelButtonClass, this.cpCancelButtonText, this.cpHeight);
    ...
    ColorPickerDirective = __decorate([
        ...
        __metadata('design:paramtypes', [core_1.ComponentFactoryResolver, core_1.ViewContainerRef, core_1.ElementRef, color_picker_service_1.ColorPickerService])
